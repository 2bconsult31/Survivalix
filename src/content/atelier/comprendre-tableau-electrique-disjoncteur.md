---
title: "Ton disjoncteur a sauté : comprendre ton tableau électrique et le réarmer sans risque"
seo_title: "Disjoncteur qui Saute : Comprendre et Réarmer son Tableau"
description: "Différentiel, divisionnaire, disjoncteur de branchement : ce que chaque élément de ton tableau électrique fait vraiment, et comment réarmer sans se mettre en danger."
date: 2025-04-23
tags: ["electricite", "tableau", "reparation", "appartement"]
rubrique: "atelier"
duree: "8 min"
image: "/images/atelier/tableau-electrique-disjoncteur.jpg"
image_alt: "Tableau électrique domestique ouvert avec ses rangées de disjoncteurs"
---
...
1. Repère le levier qui n'est pas aligné avec les autres — position basse ("0") ou intermédiaire
2. Vérifie visuellement qu'aucun fil n'est apparent, noirci ou fondu autour du disjoncteur — sans toucher à l'intérieur du tableau
3. Débranche les appareils suspects sur le circuit concerné, selon le diagnostic ci-dessus
4. Remonte fermement le levier en position haute ("I")
5. Si ça tient, rebranche les appareils un par un pour confirmer que tout fonctionne normalement
...
Si le disjoncteur a sauté à cause d'une panne plus large ou d'une coupure de courant externe, notre guide sur la [coupure d'électricité longue durée](/manuel/coupure-electricite-longue) détaille comment t'organiser en attendant le retour du courant.
